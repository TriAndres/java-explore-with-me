...
public class CompilationMapper {
    ...
    public static Compilation fromUpdateDtoToCompilation(UpdateCompilationRequestDto updateDto, Compilation compilation,
                                                         Set<Event> events) {
        compilation.setTitle((updateDto.getTitle() == null || updateDto.getTitle()
                .isBlank()) ? compilation.getTitle() : updateDto.getTitle());
